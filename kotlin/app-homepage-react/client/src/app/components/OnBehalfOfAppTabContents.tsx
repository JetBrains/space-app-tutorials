    ...
    return (
        <>
            ...
            <AppTabContents
                ...
                implementationNote="HTTP requests are made from the iframe to the app server, which then makes requests to Space with application access token. See [onBehalfOfTheAppApiImpl.ts]."
            />
        </>
    )
}
